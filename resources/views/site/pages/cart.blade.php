            ...
            <div class="row">
                    ...
                    @else
                        <div class="card">
                            <table class="table table-hover shopping-cart-wrap">
                                ...
                                <tr>
                                    <th style="font-weight:bold; color:green;">Seedling</th>
                                    <th style="font-weight:bold; color:green;">Quantity</th>
                                    <th style="font-weight:bold; color:green;">Price</th>
                                    <th style="font-weight:bold; color:green;" class="text-right" width="200">Action</th>
                                </tr>
                                </thead>
                                <tbody>
                ...
                <aside class="col-sm-4">
                    ...
                    <figure class="itemside mb-3">
                        <aside class="aside"><img src="{{ url('wave.jpg') }}" style="width:25px; height:23px;"></aside>
                        <div class="text-wrap medium text-muted">
                            Pay with Wave Pay or Wave Money
                        </div>
                    </figure>
                    <figure class="itemside mb-3">
                        <aside class="aside"> <img src="{{ url('kbz.jpeg') }}" style="width:25px; height:23px;"> </aside>
                        <div class="text-wrap medium text-muted">
                            Pay with KBZPay or KBZ Bank
                        </div>
                    </figure>
